    ...
    getData();
      ...
      return new Scaffold(
        ...
        appBar: new AppBar(
          ...
          //centerTitle -Decides whether the Appbar title will be centered or aligned to the left
          ...
          //actions — This is a list of widgets that you want to add at the end or right most side of the appBar
          elevation: 0.3,
          centerTitle: true,
          backgroundColor: Colors.white,
          leading: new Icon(
...
Future<Map> getJson() async {
  var url = 'http://api.themoviedb.org/3/discover/movie?api_key=4d9f16101775dd8297a527c24262292e';
